...
import (
	...
	server "microless/socialnetwork/text/internal/textserver"
...
func main() {
	...
	tp, err := utils.NewTracerProvider(ctx, "Text", config.Otel)
	if err != nil {
		logger.Fatal(err.Error())
	}
	...
	pb.RegisterTextServiceServer(grpcServer, server)
