...
func (c *pingServiceClient) Ping(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/microless.pingpong.ping.PingService/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPingServiceServer) Ping(context.Context, *empty.Empty) (*empty.Empty, error) {
...
func _PingService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/microless.pingpong.ping.PingService/Ping",
	}
...
var PingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "microless.pingpong.ping.PingService",
