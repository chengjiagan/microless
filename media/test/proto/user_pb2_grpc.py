...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RegisterUser = channel.unary_unary(
                '/microless.media.user.UserService/RegisterUser',
        ...
        self.Login = channel.unary_unary(
                '/microless.media.user.UserService/Login',
...
def add_UserServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'microless.media.user.UserService', rpc_method_handlers)
...
class UserService(object):
    ...
    def RegisterUser(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/microless.media.user.UserService/RegisterUser',
    ...
    def Login(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/microless.media.user.UserService/Login',
