...
import (
	...
	server "microless/acmeair/bookings/internal/bookingsserver"
...
const (
	appName = "Bookings" // name of the application shown in jaeger
	colName = "bookings" // name of mongodb collection
)
...
func main() {
	...
	pb.RegisterBookingsServiceServer(grpcServer, server)
