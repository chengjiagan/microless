...
import (
	...
	server "microless/acmeair/customer/internal/customerserver"
...
const (
	appName = "Customer" // name of the application shown in jaeger
	colName = "customer" // name of mongodb collection
)
